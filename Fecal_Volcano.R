...
# Files
dset<-read.csv("Normalised_Quant_table_batchcorrect.csv", header = TRUE)
metadata <- read.csv("20241106_metadata_fecal_batch_noblk_noqc.csv", header = T, check.names = F, sep = ",")
